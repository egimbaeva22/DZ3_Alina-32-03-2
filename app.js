...
// 2. Создайте объект Старбакса, там будут главные поля кофе, чай. В поле кофе будут еще
// поля в разновидностями кофе, их значениями должны быть описания этих кофе , можете от себя
// добавить что-то, это только приветствуется. Тоже самое и с чаем. Правильно постройте архитектуру объекта.
// Затем, после того как объект уже будет готов , напишите логику принятия заказа,
// то есть пользователь вводит название кофе или чая и
// если такой кофе или чай есть в объекте, то принять заказ, а если нет, то error)

// Вроде все. Зальем в гитхаб?
